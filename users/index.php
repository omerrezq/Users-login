...
if (isset($_POST['save'])) {
    ...
    VALUES ('$name','$email','$password', '$mobile')";
        ...
        $id = $_POST['id'];
        $save_sql = "UPDATE `users` SET `name`='$same', `email` = '$email' ,  `mobile` = '$mobile' ,
         `password` = '$password' WHERE id = $id ";
    }


    $res = mysqli_query($con, $save_sql);
    if (!$res) {
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex p-2 justify-content-evenly mb-2">
                                    <i onclick="cofirm_delete(<?php echo $user['id']; ?>)" class="text-danger" data-feather="user-x"></i>
